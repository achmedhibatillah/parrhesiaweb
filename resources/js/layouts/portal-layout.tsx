...
export default function PortalLayout({ userdata, children }) {
        ...
        <div>
            ...
            <Container className="pt-10">
                <div className="flex w-full overflow-hidden">
                    ...
                    {/* Konten utama */}
                    <div className="flex-1 transition-all duration-300 ease-in-out px-3 -mt-10 pt-11 pb-20 overflow-auto  max-h-[100vh]">
                        {children}
                    </div>

                    {/* Sidebar kanan / Identitas */}
                    <div className="xl:w-1/6 hidden xl:block">
                        <div className="sticky top-0 ps-3">
